...
# Vape 4.21 Product Recovery (NETWORKING DISABLED)

A research-oriented recovery project for the Vape 4.21 Java layer and Windows x64 native bridge layer.

**All network communication has been disabled/quarantined.** This recovery version runs in standalone mode with a sentinel token of `"0"`.
