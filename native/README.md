# Vape 4.21 native test bridge (NETWORKING DISABLED)

**All network communication has been disabled/quarantined.**
The loader bootstrap always operates in standalone mode with a sentinel token of `"0"`.
No TCP connections, shared memory IPC, or Winsock operations are performed.
