...
public class SyncThread {
    ...
    private final LocalConfigStore localConfigStore = new LocalConfigStore();
    ...
    public LocalConfigStore getLocalConfigStore() {
    ...
    public void saveLocally() {
        try {
            ...
            this.localConfigStore.save(this.buildSettingsPayload(false));
        }
    ...
    public void loadConfig() {
        try {
            JsonObject localConfig = this.localConfigStore.load();
            if (localConfig != null) {
                this.vape.loadConfigData(localConfig, false);
                for (Profile profile : this.vape.getProfilesManager().getProfiles()) {
