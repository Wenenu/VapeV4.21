...
public class AccountInfoResponse {
    ...
    public static AccountInfoResponse fromJson(@Nullable JsonElement jsonElement) {
        ...
        try {
            return new AccountInfoResponse(responseJson.get("userId").getAsLong(), ConfigJsonUtils.getString(responseJson, "username"),
                    parseApiDate(ConfigJsonUtils.getString(responseJson, "accountCreation")),
    ...
    private static Date parseApiDate(String value) throws ParseException {
        return value == null ? null : new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSXXX").parse(value);
    }
